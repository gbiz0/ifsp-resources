 ...
 */
package br.com.avaliacao1_gustavo_bizo.ctr;

import java.sql.*;
import java.sql.ResultSet;
import br.com.avaliacao1_gustavo_bizo.dto.BichoDTO;
import br.com.avaliacao1_gustavo_bizo.dao.BichoDAO;
import br.com.avaliacao1_gustavo_bizo.dao.ConexaoDAO;
...
public class BichoCTR {
    ...
    public String inserirBicho (BichoDTO bichoDTO){
        try {
            if (bichoDAO.inserirBicho(bichoDTO)){

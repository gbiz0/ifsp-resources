<div class="inicio">
    ...
    <p>
        BonziBuddy foi um assistente virtual lançado no final dos anos 90 e início dos anos 2000. Ele era representado
        por um macaco roxo animado que podia falar, cantar, contar piadas e ajudar os usuários com várias tarefas no
        computador.
    </p>
    <p>
        Embora inicialmente popular, BonziBuddy rapidamente ganhou uma reputação negativa devido ao seu comportamento
        intrusivo e à inclusão de adware e spyware. Eventualmente, o software foi descontinuado e a empresa responsável
